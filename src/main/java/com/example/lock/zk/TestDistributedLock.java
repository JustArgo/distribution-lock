...
public class TestDistributedLock {
    ...
    public static void main(String[] args) {
        ...
        final ZkClientExt zkClientExt1 = new ZkClientExt("192.168.1.101:2181", 5000, 5000, new BytesPushThroughSerializer());
        final SimpleDistributedLockMutex mutex1 = new SimpleDistributedLockMutex(zkClientExt1, "/Mutex");

        final ZkClientExt zkClientExt2 = new ZkClientExt("192.168.1.101:2181", 5000, 5000, new BytesPushThroughSerializer());
